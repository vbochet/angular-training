...
export const recipes: Recipe[] = <Recipe[]> [
    ...
    },
    {
      ...
      description: 'To many people, the Mojito represents the perfect rum cocktail. The origins of \
                    the drink can be traced back to Cuba and the 16th-century Cuban cocktail El Draque, named for Sir Francis Drake. ',
      ingredients: [
        {
          name: 'Mint leaves',
          quantity: 6,
